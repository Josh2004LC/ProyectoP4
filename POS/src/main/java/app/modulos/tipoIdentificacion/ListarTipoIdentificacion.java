 ...
 * @author Josh
 */
public class ListarTipoIdentificacion extends javax.swing.JFrame {

    /**
     * Creates new form ListarTipoIdentificacion
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarTipoIdentificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarTipoIdentificacion().setVisible(true);
            }
        });
    }
